			...
			<div class="col-sm-9 col-md-7 col-lg-5 mx-auto">
                <div class="card card-signin my-5">
                    ...
                    <form class="form-signin" v-on:submit.prevent="editManifestation">
                        ...
                        <div class="form-label-group">
                        <input type="number" min='0' v-on:keyup="evalQuantityRange($event)" step='1' id="inputAvailableSeats" class="form-control" placeholder="Available Seats" v-model="manifData.availableSeats" required>
                        ...
                        <div class="form-label-group">
                        <input type="number"  min='0' id="inputZipCode" v-on:keyup="evalQuantityRange($event)" class="form-control" placeholder="Zip Code" v-model="manifData.location.zipCode" required>
